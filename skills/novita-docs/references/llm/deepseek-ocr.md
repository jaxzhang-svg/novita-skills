---
url: "https://novita.ai/docs/guides/llm-deepseek-ocr"
title: "DeepSeek-OCR Usage - Documentation"
---

[Skip to main content](https://novita.ai/docs/guides/llm-deepseek-ocr#content-area)
...
- [Overview](https://novita.ai/docs/guides/llm-deepseek-ocr#overview)
- [Recommended Preset Prompts](https://novita.ai/docs/guides/llm-deepseek-ocr#recommended-preset-prompts)
- [Usage Example](https://novita.ai/docs/guides/llm-deepseek-ocr#usage-example)

## [​](https://novita.ai/docs/guides/llm-deepseek-ocr\#overview)  Overview
...
## [​](https://novita.ai/docs/guides/llm-deepseek-ocr\#recommended-preset-prompts)  Recommended Preset Prompts
...
## [​](https://novita.ai/docs/guides/llm-deepseek-ocr\#usage-example)  Usage Example
...
[Reasoning Models](https://novita.ai/docs/guides/llm-reasoning) [Function Calling](https://novita.ai/docs/guides/llm-function-calling)
...
![OCR Example Image](https://mintcdn.com/novitaai/WiqzsYZd3W7VMsVe/guides/images/ocr_input.jpg?w=1100&fit=max&auto=format&n=WiqzsYZd3W7VMsVe&q=85&s=4364d52073f3829099ac38eb304935a6)