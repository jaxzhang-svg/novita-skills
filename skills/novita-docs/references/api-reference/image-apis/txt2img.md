---
url: "https://novita.ai/docs/api-reference/model-apis-txt2img"
title: "Novita AI Text to Image API: Generate Stunning Visuals from Text with Stable Diffusion"
---

[Skip to main content](https://novita.ai/docs/api-reference/model-apis-txt2img#content-area)
...
## [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#request-headers)  Request Headers

[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-content-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-authorization)
...
## [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#request-body)  Request Body

[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-extra)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-response-image-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-webhook)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-url)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-test-mode)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-enabled)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-return-task-status)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-custom-storage)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-aws-s3)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-region)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-bucket)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-path)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-save-to-path-directly)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-enterprise-plan)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-enabled-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-enable-nsfw-detection)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-nsfw-detection-level)
...
2: Explicit Nudity, Explicit Sexual Activity, Sex Toys; Hate Symbols; Non-Explicit Nudity, Obstructed Intimate Parts, Kissing on the Lips; Female Swimwear or Underwear, Male Swimwear or Underwear.Enum: `0, 1, 2`

[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-request)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-model-name)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-prompt)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-width)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-height)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-image-num)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-steps)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-guidance-scale)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-sampler-name)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-negative-prompt)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-sd-vae)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-seed)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-loras)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-model-name-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-strength)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-embeddings)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-model-name-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-hires-fix)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-target-width)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-strength-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-upscaler)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-refiner)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-switch-at)
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-enable-transparent-background)

enable\_transparent\_background
...
[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-restore-faces)
...
## [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#response)  Response

[​](https://novita.ai/docs/api-reference/model-apis-txt2img#param-task-id)
...
## [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#example)  Example

### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#1-txt2img-request-with-normal-parameters)  1\. Txt2img request with normal parameters
...
### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#2-txt2img-request-with-lora)  2.Txt2img request with lora
...
### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#3-txt2img-request-with-upscale)  3.Txt2img request with upscale
...
### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#4-txt2img-request-with-sdxl-1-0)  4.Txt2img request with SDXL 1.0
...
### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#5-txt2img-request-with-textual-inversion-embedding)  5.Txt2img request with Textual Inversion(embedding)
...
### [​](https://novita.ai/docs/api-reference/model-apis-txt2img\#6-txt2img-request-with-nsfw_detection)  6.Txt2img request with nsfw\_detection
...
[Task Result](https://novita.ai/docs/api-reference/model-apis-task-result) [Image to Image](https://novita.ai/docs/api-reference/model-apis-img2img)
