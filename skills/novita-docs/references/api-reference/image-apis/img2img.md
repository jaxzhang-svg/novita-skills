---
url: "https://novita.ai/docs/api-reference/model-apis-img2img"
title: "Novita AI Image to Image API | Generate Images with Stable Diffusion Models"
---

[Skip to main content](https://novita.ai/docs/api-reference/model-apis-img2img#content-area)
...
> This is an **asynchronous API**; only the **task\_id** is returned initially. Use this **task\_id** to query the [**Task Result API**](https://novita.ai/docs/api-reference/model-apis-task-result) to retrieve the results of the image generation.

## [​](https://novita.ai/docs/api-reference/model-apis-img2img\#request-headers)  Request Headers

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-content-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-authorization)
...
## [​](https://novita.ai/docs/api-reference/model-apis-img2img\#request-body)  Request Body

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-extra)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-response-image-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-webhook)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-url)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-test-mode)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-enabled)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-return-task-status)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-custom-storage)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-aws-s3)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-region)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-bucket)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-path)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-save-to-path-directly)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-enterprise-plan)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-enabled-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-enable-nsfw-detection)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-nsfw-detection-level)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-request)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-model-name)
...
This parameter specifies the name of the model checkpoint. Retrieve the corresponding sd\_name value by invoking the [Query Model](https://novita.ai/api-reference/model-apis-get-model) API with filter.types=checkpoint as the query parameter.

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-image-base64)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-prompt)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-width)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-height)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-image-num)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-steps)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-guidance-scale)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-sampler-name)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-negative-prompt)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-sd-vae)

sd\_vae

string

VAE (Variational Auto Encoder). sd\_vae can be accessed in the API /v3/models with query params type=vae, like sd\_name: customVAE.safetensors. Get reference at [A Brief Introduction to VAE](https://novita.ai/docs/guides/model-apis-vae).

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-controlnet)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-units)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-model-name-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-image-base64-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-strength)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-preprocessor)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-guidance-start)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-guidance-end)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-seed)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-loras)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-model-name-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-strength-1)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-embeddings)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-model-name-3)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-clip-skip)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-strength-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-ip-adapters)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-model-name-4)
...
IP-Adapter model name, if the base model of your checkpoint is SDXL, then you should select ip-adapter\_sdxl.bin. Alternatively, if the base model of your checkpoint is SD1.x, then you should select ip-adapter\_sd15.bin.

Enum: `ip-adapter_sd15.bin`, `ip-adapter_sdxl.bin`

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-image-base64-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-strength-3)
...
## [​](https://novita.ai/docs/api-reference/model-apis-img2img\#response)  Response

[​](https://novita.ai/docs/api-reference/model-apis-img2img#param-task-id)
...
## [​](https://novita.ai/docs/api-reference/model-apis-img2img\#example)  Example

### [​](https://novita.ai/docs/api-reference/model-apis-img2img\#1-image-to-image-request-with-normal-parameter)  1\. Image to image request with normal parameter.

Please set the **`Content-Type`** header to **`application/json`** in your HTTP request to indicate that you are sending JSON data. Currently, **only JSON format is supported**.`Request:`
...
### [​](https://novita.ai/docs/api-reference/model-apis-img2img\#2-image-to-image-request-with-controlnet)  2\. Image to image request with controlNet.
...
### [​](https://novita.ai/docs/api-reference/model-apis-img2img\#3-image-to-image-request-with-textual-inversion-embedding)  3\. Image to image request with Textual Inversion(embedding).

Please set the **`Content-Type`** header to **`application/json`** in your HTTP request to indicate that you are sending JSON data. Currently, **only JSON format is supported**.`Request for textual inversion names:`
...
### [​](https://novita.ai/docs/api-reference/model-apis-img2img\#4-img2img-request-with-nsfw_detection)  4\. Img2img request with nsfw\_detection.

When set `enable_nsfw_detection` true, NSFW detection will be enabled, incurring an additional cost of $0.0015 for each generated image.`nsfw_detection_level`, nsfw check level, ranging from 0 to 2, with higher levels indicating stricter NSFW detection criteria. The default value is 0. The following table lists the NSFW detection criteria for each level.
...
**Use `task_id` to get images**HTTP status codes in the 2xx range indicate that the request has been successfully accepted, while status codes in the 5xx range indicate internal server errors.You can get images url in `imgs` of response.There are two results in reponse.
...
[Text to Image](https://novita.ai/docs/api-reference/model-apis-txt2img) [Reimagine](https://novita.ai/docs/api-reference/model-apis-reimagine)
