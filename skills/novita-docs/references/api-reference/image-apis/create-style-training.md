---
url: "https://novita.ai/docs/api-reference/model-apis-create-style-training"
title: "LoRA for Style Training - Documentation"
---

[Skip to main content](https://novita.ai/docs/api-reference/model-apis-create-style-training#content-area)
...
- [Create Style Training Task](https://novita.ai/docs/api-reference/model-apis-create-style-training#create-style-training-task)
- [Request Headers](https://novita.ai/docs/api-reference/model-apis-create-style-training#request-headers)
- [Request Body](https://novita.ai/docs/api-reference/model-apis-create-style-training#request-body)
- [Response](https://novita.ai/docs/api-reference/model-apis-create-style-training#response)
- [Get style training result](https://novita.ai/docs/api-reference/model-apis-create-style-training#get-style-training-result)
- [Request Headers](https://novita.ai/docs/api-reference/model-apis-create-style-training#request-headers-2)
- [Request Body](https://novita.ai/docs/api-reference/model-apis-create-style-training#request-body-2)
- [Response](https://novita.ai/docs/api-reference/model-apis-create-style-training#response-2)
- [Example](https://novita.ai/docs/api-reference/model-apis-create-style-training#example)
- [1\. Upload images for training](https://novita.ai/docs/api-reference/model-apis-create-style-training#1-upload-images-for-training)
- [1.1 Get image upload URL](https://novita.ai/docs/api-reference/model-apis-create-style-training#1-1-get-image-upload-url)
- [1.2 Upload images](https://novita.ai/docs/api-reference/model-apis-create-style-training#1-2-upload-images)
- [2\. Start training task and configure parameters](https://novita.ai/docs/api-reference/model-apis-create-style-training#2-start-training-task-and-configure-parameters)
- [3\. Get training status](https://novita.ai/docs/api-reference/model-apis-create-style-training#3-get-training-status)
- [3.1 Get model training and deployment status](https://novita.ai/docs/api-reference/model-apis-create-style-training#3-1-get-model-training-and-deployment-status)
- [3.2 Start using the trained model](https://novita.ai/docs/api-reference/model-apis-create-style-training#3-2-start-using-the-trained-model)
- [3.3 List training tasks](https://novita.ai/docs/api-reference/model-apis-create-style-training#3-3-list-training-tasks)
- [4\. Training playground](https://novita.ai/docs/api-reference/model-apis-create-style-training#4-training-playground)
- [4.1 Input Novita AI API Key, images and select training type](https://novita.ai/docs/api-reference/model-apis-create-style-training#4-1-input-novita-ai-api-key-images-and-select-training-type)
- [4.2 Switch to the inferencing tab and add more detail](https://novita.ai/docs/api-reference/model-apis-create-style-training#4-2-switch-to-the-inferencing-tab-and-add-more-detail)
- [Review the training results](https://novita.ai/docs/api-reference/model-apis-create-style-training#review-the-training-results)

**You can train a LoRA model to generate images that emulate a specific artistic style.**

## [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#create-style-training-task)  Create Style Training Task

`POST https://api.novita.ai/v3/training/style`**Use this API to start a style training task.**

> This is an **asynchronous API**; only the **task\_id** is returned initially. Utilize this **task\_id** to query the **Task Result API** at [Get Style Training Result API](https://novita.ai/docs/api-reference/model-apis-create-style-training#get-style-training-result) to retrieve the results of the image generation.

### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#request-headers)  Request Headers

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-content-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-authorization)
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#request-body)  Request Body

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-name)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-base-model)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-width)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-height)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-image-dataset-items)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-assets-id)
...
Image asset ID; see [Upload Images For Training](https://novita.ai/docs/api-reference/model-apis-create-style-training#_1-upload-images-for-training) for reference.

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-caption)
...
Image caption; refer to [Training Image Caption Guidance](https://novita.ai/guides/model-apis-training-guidance) for more information.

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-expert-setting)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-train-batch-size)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-learning-rate)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-max-train-steps)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-seed)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-lr-scheduler)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-lr-warmup-steps)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-components)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-name-1)
...
Type of components. When set to `face_crop_region`, args can be set to args: \[name: ratio, value: 1.0\], ratio > 1 means more non-facial area will be included. When set to `resize`, args can be set to args: \[name: width, value: 512, name: height, value: 512\], which mean all the images will be cropped to 512\*512. When set to `face_restore`, args can be set to args: \[name: method, value:gfpgan\_1.4\], which mean face restore will be open.

Enum: `face_crop_region`, `resize`, `face_restore`

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-args)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-name-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-value)
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#response)  Response

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-task-id)

task\_id

string

Utilize this `task_id` to query the Task Result API at [Get style training result](https://novita.ai/docs/api-reference/model-apis-create-style-training#get-style-training-result).

## [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#get-style-training-result)  Get style training result

`GET https://api.novita.ai/v3/training/style`**Use this API to get the style training result, including the model.**

### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#request-headers-2)  Request Headers

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-authorization-1)
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#request-body-2)  Request Body

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-task-id-1)
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#response-2)  Response

[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-task-id-2)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-task-status)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-model-type)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-models)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-model-name)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-model-status)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-extra)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-eta-relative)
...
[​](https://novita.ai/docs/api-reference/model-apis-create-style-training#param-progress-percent)
...
## [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#example)  Example
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#1-upload-images-for-training)  1\. Upload images for training
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#1-1-get-image-upload-url)  1.1 Get image upload URL
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#1-2-upload-images)  1.2 Upload images
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#2-start-training-task-and-configure-parameters)  2\. Start training task and configure parameters
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#3-get-training-status)  3\. Get training status

#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#3-1-get-model-training-and-deployment-status)  3.1 Get model training and deployment status
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#3-2-start-using-the-trained-model)  3.2 Start using the trained model
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#3-3-list-training-tasks)  3.3 List training tasks
...
### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#4-training-playground)  4\. Training playground
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#4-1-input-novita-ai-api-key-images-and-select-training-type)  4.1 Input Novita AI API Key, images and select training type

![](https://next-app-static.s3.ap-southeast-1.amazonaws.com/get-started/training_playground01.png)

#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#4-2-switch-to-the-inferencing-tab-and-add-more-detail)  4.2 Switch to the inferencing tab and add more detail
...
#### [​](https://novita.ai/docs/api-reference/model-apis-create-style-training\#review-the-training-results)  Review the training results
...
[LoRA for Subject Training](https://novita.ai/docs/api-reference/model-apis-create-subject-training) [List LoRA Training Task](https://novita.ai/docs/api-reference/model-apis-list-training-task)
